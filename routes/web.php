...
use App\Http\Controllers\TestRegistrationsController;
Route::prefix('test-registration')->name('test-registration.')->group(function () {
    Route::get( '/', [TestRegistrationsController::class, 'index'])->name('index');
    Route::post('/', [TestRegistrationsController::class, 'store'])->name('store');
    Route::post('/{registration}/status', [TestRegistrationsController::class, 'changeStatus'])->name('status');
});

//TODO : Remove this test route when the synonyms service is fully integrated into the application.
use App\Http\Controllers\TestSynonymsController;
Route::prefix('test-synonyms')->name('test-synonyms.')->group(function () {
    Route::get(   '/', [TestSynonymsController::class, 'index'])->name('index');
    Route::post(  '/', [TestSynonymsController::class, 'store'])->name('store');
    Route::put(   '/', [TestSynonymsController::class, 'update'])->name('update');
    Route::delete('/', [TestSynonymsController::class, 'destroy'])->name('delete');
});

// TODO : Remove this test route when the keywords service is fully integrated into the application.
use App\Http\Controllers\TestKeywordsController;
Route::prefix('test-keywords')->name('test-keywords.')->group(function () {
    Route::get('/', [TestKeywordsController::class, 'index'])->name('index');
    Route::post('/attach', [TestKeywordsController::class, 'attach'])->name('attach');
    Route::post('/detach', [TestKeywordsController::class, 'detach'])->name('detach');
});

// TODO : Remove this test route when the keywords service is fully integrated into the application.
use App\Http\Controllers\TestArtistChangeRequestController;
Route::prefix('test-changes')->name('test-changes.')->group(function () {
    Route::get('/', [TestArtistChangeRequestController::class, 'index'])->name('index');
    Route::post('/', [TestArtistChangeRequestController::class, 'store'])->name('store');
    Route::get('/requests', [TestArtistChangeRequestController::class, 'requests'])->name('requests');
    Route::post('/requests/{changeRequest}/status', [TestArtistChangeRequestController::class, 'changeStatus'])->name('requests.status');
});
