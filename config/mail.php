...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Global "To" Override (dev / staging catch-all)
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Subject Prefix (staging catch-all)
    |--------------------------------------------------------------------------
    |
    | When set, this string is prepended to every outgoing mail subject.
    | Useful on staging to clearly mark mails as non-production.
    | Example: "[STAGING] - "
    |
    */
